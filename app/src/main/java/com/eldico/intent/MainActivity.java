...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String [] namaKota = {"Jakarta", "Bekasi", "Tangerang Kota", "Tangerang Selatan", "Bogor", "Depok","Palembang"};
        ...
        String [] namaHobby = {"Cooking", "Olahraga", "Gaming", "Travelling", "Musik", "Belajar"};
        ...
        // sejenis pop-up
        Toast.makeText(this, "fungsi onCreate", Toast.LENGTH_LONG).show();
    }
